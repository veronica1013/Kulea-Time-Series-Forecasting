...
end_date <- as.Date("2023-03-01 00:00:00")
...
arima_model <- Arima(ts_data,
                     order = c(1, 0, 4), #
                     seasonal = list(order = c(0, 2, 1), period = 24)) #2, 1,1
...
forecast_south_africa_production <- forecast(arima_model, level = c(95), h = 4 * 12)
...
# file_path <- "forecast_south_africa_exports_2026_2028.csv"
