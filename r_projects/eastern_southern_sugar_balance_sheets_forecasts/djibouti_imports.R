...
forecast_djibouti_imports <- forecast(arima_model, level = c(95), h = 4 * 12)
# plot(forecast_djibouti_imports)
print(forecast_djibouti_imports)
...
# file_path <- "forecast_djibouti_imports_2026_2027.csv"

# # Save the forecast to a CSV file
# write.csv(forecast_djibouti_imports, file = file_path, row.names = TRUE)