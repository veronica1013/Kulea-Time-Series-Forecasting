...
forecast_eswatini_exports <- forecast(arima_model, level = c(95), h = 2 * 12)
plot(forecast_eswatini_exports)
print(forecast_eswatini_exports)
...
# file_path <- "forecast_eswatini_overall_exports_2026_2028.csv"

# # Save the forecast to a CSV file
# write.csv(forecast_eswatini_exports, file = file_path, row.names = TRUE)