...
forecast_djibouti_high_q_cons <- forecast(arima_model, level = c(95), h = 4 * 12)
# plot(forecast_djibouti_high_q_cons)
print(forecast_djibouti_high_q_cons)
...
file_path <- "forecast_djibouti_high_q_cons_2026_2027.csv"

# Save the forecast to a CSV file
write.csv(forecast_djibouti_high_q_cons, file = file_path, row.names = TRUE)