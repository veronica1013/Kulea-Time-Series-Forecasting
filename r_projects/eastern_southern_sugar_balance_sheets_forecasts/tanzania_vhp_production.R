...
library(readxl)
library(tseries)
data <- read_excel("D:\\kulea_projects\\r_project\\east_south_sugar\\Tanzania.xlsx",
                   sheet = "Tanzania", skip = 1)
head(data)
num_col <- ncol(data)
...
end_date <- as.Date("2026-07-01 00:00:00")
...
file_path <- "forecast_tanzania_vhp_production_2026_2028.csv"
