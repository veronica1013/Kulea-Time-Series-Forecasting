...
forecast_mauritius_exports <- forecast(arima_model, level = c(95), h = 2 * 12)
plot(forecast_mauritius_exports)
print(forecast_mauritius_exports)
...
file_path <- "forecast_mauritius_exports_2026_2028.csv"

# Save the forecast to a CSV file
write.csv(forecast_mauritius_exports, file = file_path, row.names = TRUE)