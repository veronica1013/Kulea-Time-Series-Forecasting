...
arima_model <- Arima(ts_data,
                     order = c(1, 1, 0), #
                     seasonal = list(order = c(0, 1, 1), period = 24)) #156
...
forecast_south_africa_production <- forecast(arima_model, level = c(95), h = 3 * 12)
...
file_path <- "forecast_zambia_vhp_consumption_2026_2028.csv"
