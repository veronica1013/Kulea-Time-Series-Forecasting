...
print(col_names)
sel_data <- data[, c("Month", "Low-Quality(special sugars) prod"
)]
print(head(sel_data))
...
ts_data <- ts(sel_data_2$`Low-Quality(special sugars) prod`,
...
file_path <- "forecast_mauritius_low_q_production_2026_2028.csv"
