...
# forecast_dates <- seq(end_date, end_date + 1233, by = "day")  # Forecast for 1 year (365 days) from the end date
...
forecast_global_sugar_11_feb_21_2024 <- forecast(arima_model, level = c(95), h = 24 * 12)
plot(forecast_global_sugar_11_feb_21_2024)
